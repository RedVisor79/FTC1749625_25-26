...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -0.927/TwoDeadWheelLocalizer.inPerTick; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -4.043/TwoDeadWheelLocalizer.inPerTick; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public static double inPerTick = 2 * Math.PI * (0.985*(48/48.1017)) / 8192;
